async function mainn_out(p1, p2, p3, imgsrc, imgalt, imgtitle) {
    let container = document.getElementById("mi-24-main")
...
async function lth_out(p1, imgsrc, imgalt, imgtitle, gabarp2, gabarp3, gabarp4, gabarp5, gabarp6, lthp1, lthp2, lthp3, lthp4, lthp5, lthp6, lthp7, lthp8, lthp9, lthp10, lthp11, lthp12, lthp13, lthp14) {
    let container = document.getElementById("mi-24-lth")
...
async function ozbr_out(p1, imgsrc, imgalt, imgtitle, pimg, p2, p3) {
    let container = document.getElementById("mi-24-ozbr")
...
async function kursove_out(p1, imgsrc, imgalt, imgtitle, pimg, p2, p3) {
    let container = document.getElementById("mi-24-kursove")
...
async function pidvisne_out(p1, p2, p3, p4, img1src, img1alt, img1title, pimg1, pimggr1, pimggr2, pimggr3, imggr11src, imggr12src, imggr13src, imggr11alt, imggr12alt, imggr13alt, imggr11title, imggr12title, imggr13title, imggr21src, imggr22src, imggr21alt, imggr22alt, imggr21title, imggr22title, imggr31src, imggr32src, imggr31alt, imggr32alt, imggr31title, imggr32title) {
    let container = document.getElementById("mi-24-pidvisne")
...
async function history_out(p1, p2, p3, p4) {
    let container = document.getElementById("mi-24-history")
...
async function mi24a_out(p1, p2, p3, pimg, imgsrc, imgalt, imgtitle) {
    let container = document.getElementById("mi-24-mi24a")
...
async function mi24py1_out(p1, p2, img1src, img1alt, img1title, img2src, img2alt, img2title) {
    let container = document.getElementById("mi-24-mi24py1")
...
async function mi24py1_history_out(p1, p2) {
    let container = document.getElementById("mi-24-mi24py1-history")
...
async function mi24py1_modern_out(p1, p2, p3, p4, p5, p6, p7) {
    let container = document.getElementById("mi-24-mi24py1-modern")
...
async function Get_Mainn() {
    fetch("http://localhost:8300/Mi24MainServlet").then(
        (response) => {
        ...
        mainn_out(p1, p2, p3, imgsrc, imgalt, imgtitle)
    })
}
async function Get_Lth() {
    fetch("http://localhost:8300/Mi24LTHServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        lth_out(p1, imgsrc, imgalt, imgtitle, gabarp2, gabarp3, gabarp4, gabarp5, gabarp6, lthp1, lthp2, lthp3, lthp4, lthp5, lthp6, lthp7, lthp8, lthp9, lthp10, lthp11, lthp12, lthp13, lthp14)
    })
}
async function Get_Ozbr() {
    fetch("http://localhost:8300/Mi24OzbrServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        ozbr_out(p1, imgsrc, imgalt, imgtitle, pimg, p2, p3)
    })
}
async function Get_Kursove() {
    fetch("http://localhost:8300/Mi24KursoveServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        kursove_out(p1, imgsrc, imgalt, imgtitle, pimg, p2, p3)
    })
}
async function Get_Pidvisne() {
    fetch("http://localhost:8300/Mi24PidvisneServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        pidvisne_out(p1, p2, p3, p4, img1src, img1alt, img1title, pimg1, pimggr1, pimggr2, pimggr3, imggr11src, imggr12src, imggr13src, imggr11alt, imggr12alt, imggr13alt, imggr11title, imggr12title, imggr13title, imggr21src, imggr22src, imggr21alt, imggr22alt, imggr21title, imggr22title, imggr31src, imggr32src, imggr31alt, imggr32alt, imggr31title, imggr32title)
    })
}
async function Get_History() {
    fetch("http://localhost:8300/Mi24HistoryServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        history_out(p1, p2, p3, p4)
    })
}
async function Get_Mi24A() {
    fetch("http://localhost:8300/Mi24AServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        mi24a_out(p1, p2, p3, pimg, imgsrc, imgalt, imgtitle)
    })
}
async function Get_Mi24PY1() {
    fetch("http://localhost:8300/Mi24PY1Servlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        mi24py1_out(p1, p2, img1src, img1alt, img1title, img2src, img2alt, img2title)
    })
}
async function Get_Mi24PY1History() {
    fetch("http://localhost:8300/Mi24PY1HistoryServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        mi24py1_history_out(p1, p2)
    })
}
async function Get_Mi24PY1Modern() {
    fetch("http://localhost:8300/Mi24PY1ModernServlet").then(
        (response) => {
            return response.text()
        }
    ).then((text) => {
        ...
        mi24py1_modern_out(p1, p2, p3, p4, p5, p6, p7)
    })
}
